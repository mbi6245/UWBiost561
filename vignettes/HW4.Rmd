...
1. I'm hoping to see whether or not the different implementations can correctly deduce a maximal partial clique. This will be determined by checking whether or not the edge density calculated by an implementation is correct, incorrect, or if the implementation didn't finish running. I'll plot the occurrences of each in a barplot for each level of alpha.
...
![plot of results](HW4_simulation.png){width=50%}
